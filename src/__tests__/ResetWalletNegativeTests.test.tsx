...
/**
 * Test resetWallet method behaviour if the function with the same title in NativeModule throwed a error or produced response of bad format. 
...
jest.mock('react-native', () => {
        ...
        NfcCardModule: {
            resetWallet: jest.fn()
             ...
             .mockReturnValueOnce(new Promise((_resolve, reject) => {
              ...
              .mockReturnValueOnce(new Promise((_resolve, reject) => {
                reject(new Error("{\"message\":\"Command aborted, No precise diagnosis.\", \"code\": \"6F00\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction1\":\"RESET_WALLET\", \"apdu\":\"80 CB 80 00 05 DFFE028205\"}"
                ));
              }))
              .mockReturnValueOnce(new Promise((_resolve, reject) => {
                reject(new Error("{\"message\":\"Command aborted, No precise diagnosis.\", \"code\": \"6F00\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction\":\"\", \"apdu\":\"80 CB 80 00 05 DFFE028205\"}"
                ));
              }))
              .mockReturnValueOnce(new Promise((_resolve, reject) => {
                reject(new Error("{\"message\":\"Command aborted, No precise diagnosis.\", \"code\": \"6F00\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction\":\"RESET_WALLET\", \"apdu1\":\"80 CB 80 00 05 DFFE028205\"}"
                ));
              }))
              .mockReturnValueOnce(new Promise((_resolve, reject) => {
              ...
              .mockReturnValueOnce(new Promise((_resolve, reject) => {
                reject(new Error("{\"message\":\"Command aborted, No precise diagnosis.\", \"code\": \"6F00\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction\":\"RESET_WALLET\", \"apdu\":\"80 CB 80 00 05 DFFE028205\"}"
                ));
              }))
  ...
  */
  ...
  test('Test resetWallet throws error if message field (in response) is empty', () => {
    return new NfcCardModuleWrapper().resetWallet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetWallet throws error if message field (in response) is absent', () => {
    return new NfcCardModuleWrapper().resetWallet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
 ...
 test('Test resetWallet throws error if message field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().resetWallet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetWallet throws error if message field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().resetWallet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetWallet throws error if status field (in response) is empty', () => {
    return new NfcCardModuleWrapper().resetWallet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetWallet throws error if status field (in response) is absent', () => {
    return new NfcCardModuleWrapper().resetWallet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetWallet throws error if status field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().resetWallet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetWallet throws error if status field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().resetWallet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetWallet throws CardError if errorTypeId =  0', () => {
    ...
    .catch(error => {
        ...
        expect(error.apdu).toBe('80 CB 80 00 05 DFFE028205');
    });  
  });
