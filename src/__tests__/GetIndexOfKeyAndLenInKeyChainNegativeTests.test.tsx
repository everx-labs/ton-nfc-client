...
jest.mock('react-native', () => {
    return {
      NativeModules: {
        NfcCardModule: {
            getIndexAndLenOfKeyInKeyChain: jest.fn().mockReturnValueOnce(new Promise((resolve, reject) => {
            ...
            getIndexAndLenOfKeyInKeyChainWithoutDialog: jest.fn().mockReturnValueOnce(new Promise((resolve, reject) => {
                reject(new Error("aaa"));
              }))
              .mockReturnValueOnce(new Promise((resolve, reject) => {
                reject(new Error("{\"message\":\"\", \"status\":\"fail\", \"code\": \"30006\", \"errorTypeId\": \"3\", \"errorType\": \"Native code fail: incorrect format of input data\"}"
 ...
 test('Test getIndexAndLenOfKeyInKeyChain throws error if message field is empty', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChain("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChain throws error if message field is absent', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChain("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChain throws error if status field is empty', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChain("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChain throws error if status field is absent', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChain("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  /*
  getIndexAndLenOfKeyInKeyChainWithoutDialog
  */

  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog: throws error if input arg is not json', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
    .catch(error => {
 ...
 test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if message field is empty', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if message field is absent', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if status field is empty', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if status field is absent', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if code field is empty', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if code field is absent', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if errorType field is empty', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if errorType field is absent', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if errorTypeId field is empty', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if errorTypeId field is absent', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if cardInstruction field is empty', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if cardInstruction field is absent', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if apdu field is empty', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws error if apdu field is absent', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws CardError if errorTypeId =  0', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getIndexAndLenOfKeyInKeyChainWithoutDialog throws NfcNativeModuleError if errorTypeId >  0', () => {
    return new NfcCardModuleWrapper().getIndexAndLenOfKeyInKeyChainWithoutDialog("AABBCC1122334455AABBCC1122334455AABBCC1122334455AABBCC1122334455")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
