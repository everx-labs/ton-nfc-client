...
jest.mock('react-native', () => {
    return {
      NativeModules: {
        NfcCardModule: {
            getDeleteKeyRecordNumOfPackets: jest.fn().mockReturnValueOnce(new Promise((resolve, reject) => {
            ...
            getDeleteKeyRecordNumOfPacketsWithoutDialog: jest.fn().mockReturnValueOnce(new Promise((resolve, reject) => {
                reject(new Error("aaa"));
              }))
              .mockReturnValueOnce(new Promise((resolve, reject) => {
                reject(new Error("{\"message\":\"\", \"status\":\"fail\", \"code\": \"30006\", \"errorTypeId\": \"3\", \"errorType\": \"Native code fail: incorrect format of input data\"}"
 ...
 test('Test getDeleteKeyRecordNumOfPackets throws error if message field is empty', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPackets()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPackets throws error if message field is absent', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPackets()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPackets throws error if status field is empty', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPackets()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPackets throws error if status field is absent', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPackets()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  /*
  getDeleteKeyRecordNumOfPacketsWithoutDialog
  */

  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog: throws error if input arg is not json', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
    .catch(error => {
 ...
 test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if message field is empty', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if message field is absent', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if status field is empty', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if status field is absent', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if code field is empty', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if code field is absent', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if errorType field is empty', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if errorType field is absent', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if errorTypeId field is empty', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if errorTypeId field is absent', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if cardInstruction field is empty', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if cardInstruction field is absent', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if apdu field is empty', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws error if apdu field is absent', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws CardError if errorTypeId =  0', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getDeleteKeyRecordNumOfPacketsWithoutDialog throws NfcNativeModuleError if errorTypeId >  0', () => {
    return new NfcCardModuleWrapper().getDeleteKeyRecordNumOfPacketsWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
