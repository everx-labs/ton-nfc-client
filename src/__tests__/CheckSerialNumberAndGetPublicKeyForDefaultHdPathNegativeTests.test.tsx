...
import {ERR_JSON_MUST_HAVE_MSG_FIELD, 
  ...
  ERR_JSON_MUST_HAVE_APDU_FIELD} from '../NfcCardModuleWrapper'
      ...
      /**
 * Test checkSerialNumberAndGetPublicKeyForDefaultPath method behaviour if the function with the same title in NativeModule throwed a error. 
...
jest.mock('react-native', () => {
    return {
      NativeModules: {
        NfcCardModule: {
            checkSerialNumberAndGetPublicKeyForDefaultPath: jest.fn().mockReturnValueOnce(new Promise((_resolve, reject) => {
  ...
  */
  ...
  test('Test checkSerialNumberAndGetPublicKeyForDefaultPath throws error if message field (in response) is empty', () => {
    return new NfcCardModuleWrapper().checkSerialNumberAndGetPublicKeyForDefaultPath("504394802433901126813236")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkSerialNumberAndGetPublicKeyForDefaultPath throws error if message field (in response) is absent', () => {
    return new NfcCardModuleWrapper().checkSerialNumberAndGetPublicKeyForDefaultPath("504394802433901126813236")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
 ...
 test('Test checkSerialNumberAndGetPublicKeyForDefaultPath throws error if message field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().checkSerialNumberAndGetPublicKeyForDefaultPath("504394802433901126813236")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkSerialNumberAndGetPublicKeyForDefaultPath throws error if message field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().checkSerialNumberAndGetPublicKeyForDefaultPath("504394802433901126813236")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkSerialNumberAndGetPublicKeyForDefaultPath throws error if status field (in response) is empty', () => {
    return new NfcCardModuleWrapper().checkSerialNumberAndGetPublicKeyForDefaultPath("504394802433901126813236")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkSerialNumberAndGetPublicKeyForDefaultPath throws error if status field (in response) is absent', () => {
    return new NfcCardModuleWrapper().checkSerialNumberAndGetPublicKeyForDefaultPath("504394802433901126813236")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkSerialNumberAndGetPublicKeyForDefaultPath throws error if status field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().checkSerialNumberAndGetPublicKeyForDefaultPath("504394802433901126813236")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkSerialNumberAndGetPublicKeyForDefaultPath throws error if status field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().checkSerialNumberAndGetPublicKeyForDefaultPath("504394802433901126813236")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
