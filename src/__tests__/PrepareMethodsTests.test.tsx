...
test('Positive test prepareCardResponse', () => {
  ...
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  return nfcCardModuleWrapper.prepareCardResponse(json).then(cardRsponse => {
    console.log(json);
...
test('Test prepareCardResponse throws error if message field is absent', () => {
  ...
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  return nfcCardModuleWrapper.prepareCardResponse(json).catch(error => {
...
test('Positive test prepareCardResponseFromGetAllSerialNumbers', () => {
  ...
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  return nfcCardModuleWrapper.prepareCardResponseFromGetAllSerialNumbers(json).then(cardRsponse => {
    console.log(json);
...
test('Test prepareCardResponseFromGetAllSerialNumbers throws error if message field is absent', () => {
  let json = "{\"message1\":\"22221\", \"status\":\"ok\"}";
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  return nfcCardModuleWrapper.prepareCardResponseFromGetAllSerialNumbers(json).catch(error => {
    expect(error.message).toBe('Json must have \"message\" field!');
  });  
});
...
test('Positive test prepareCardResponseFromGetHashes', () => {
  ...
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  return nfcCardModuleWrapper.prepareCardResponseFromGetHashes(json).then(cardRsponse => {
    console.log(json);
    expect(cardRsponse.message).toBe("");
    expect(cardRsponse.status).toBe("ok");
...
test('Positive test prepareCardResponseFromGetKeyChainInfo', () => {
  ...
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  return nfcCardModuleWrapper.prepareCardResponseFromGetKeyChainInfo(json).then(cardRsponse => {
    console.log(json);
    expect(cardRsponse.message).toBe("");
    expect(cardRsponse.status).toBe("ok");
    expect(cardRsponse.ecsHash).toBe("");
...
test('Test prepareCardResponseFromGetKeyChainInfo throws error if numberOfKeys field is absent', () => {
  ...
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  return nfcCardModuleWrapper.prepareCardResponseFromGetKeyChainInfo(json).catch(error => {
...
test('Positive test prepareCardResponseFromGetHmac', () => {
  ...
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  return nfcCardModuleWrapper.prepareCardResponseFromGetHmac(json).then(cardRsponse => {
    console.log(json);
    expect(cardRsponse.message).toBe("");
    expect(cardRsponse.status).toBe("ok");
    expect(cardRsponse.ecsHash).toBe("");
...
test('Test prepareCardResponseFromGetHmac throws error if hmac field is absent', () => {
  ...
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  return nfcCardModuleWrapper.prepareCardResponseFromGetHmac(json).catch(error => {
...
test('Test throwError throws error if errorTypeId =  0 and cardInstruction field is absent', () => {
  let json = "{\"message\":\"Incorrect PIN (from Ton wallet applet).\", \"code\": \"6F07\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction1\":\"VERIFY_PIN\", \"apdu\":\"B0 A2 00 00 44\"}";
  console.log(json);
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  expect(() => {
    let cardRsponse = nfcCardModuleWrapper.throwError(json);
...
test('Test throwError throws error if errorTypeId =  0 and cardInstruction field is empty', () => {
  let json = "{\"message\":\"Incorrect PIN (from Ton wallet applet).\", \"code\": \"6F07\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction\":\"\", \"apdu\":\"B0 A2 00 00 44\"}";
  console.log(json);
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  expect(() => {
    let cardRsponse = nfcCardModuleWrapper.throwError(json);
...
test('Test throwError throws error if errorTypeId =  0 and apdu field is absent', () => {
  let json = "{\"message\":\"Incorrect PIN (from Ton wallet applet).\", \"code\": \"6F07\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction\":\"VERIFY_PIN\", \"apdu1\":\"B0 A2 00 00 44\"}";
  console.log(json);
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  expect(() => {
    let cardRsponse = nfcCardModuleWrapper.throwError(json);
...
test('Test throwError throws error if errorTypeId =  0 and apdu field is empty', () => {
  let json = "{\"message\":\"Incorrect PIN (from Ton wallet applet).\", \"code\": \"6F07\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction\":\"VERIFY_PIN\", \"apdu\":\"\"}";
  console.log(json);
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  expect(() => {
    let cardRsponse = nfcCardModuleWrapper.throwError(json);
...
test('Positive Test throwError throws error if errorTypeId =  0', () => {
  let json = "{\"message\":\"Incorrect PIN (from Ton wallet applet).\", \"code\": \"6F07\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction\":\"VERIFY_PIN\", \"apdu\":\"B0 A2 00 00 44\"}";
  console.log(json);
  let nfcCardModuleWrapper = new NfcCardModuleWrapper();
  expect(() => {
    let cardRsponse = nfcCardModuleWrapper.throwError(json);
  }).toThrow(new CardError("Incorrect PIN (from Ton wallet applet).", "fail", "6F07", "0", "Applet fail: card operation error", "VERIFY_PIN", "B0 A2 00 00 44"));
});
