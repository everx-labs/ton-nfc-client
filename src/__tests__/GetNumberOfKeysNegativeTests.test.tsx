...
jest.mock('react-native', () => {
 ...
 test('Test getNumberOfKeys throws error if message field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
  ...
  test('Test getNumberOfKeys throws error if message field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws error if status field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws error if status field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws error if code field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws error if code field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws error if errorType field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws error if errorType field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws error if errorTypeId field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws error if errorTypeId field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws error if cardInstruction field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws error if cardInstruction field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws error if apdu field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws error if apdu field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws CardError if errorTypeId =  0', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeys throws NfcNativeModuleError if errorTypeId >  0', () => {
    return new NfcCardModuleWrapper().getNumberOfKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  /*
  getNumberOfKeysWithoutDialog
  */

 test('Test getNumberOfKeysWithoutDialog throws error if message field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
    .catch(error => {
  ...
  test('Test getNumberOfKeysWithoutDialog throws error if message field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws error if status field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws error if status field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws error if code field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws error if code field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws error if errorType field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws error if errorType field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws error if errorTypeId field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws error if errorTypeId field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws error if cardInstruction field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws error if cardInstruction field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws error if apdu field is empty', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws error if apdu field is absent', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws CardError if errorTypeId =  0', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getNumberOfKeysWithoutDialog throws NfcNativeModuleError if errorTypeId >  0', () => {
    return new NfcCardModuleWrapper().getNumberOfKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
