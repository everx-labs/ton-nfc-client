...
import {ERR_JSON_MUST_HAVE_MSG_FIELD, 
 ...
 /**
 * Test isRecoveryDataSet method behaviour if the function with the same title in NativeModule throwed a error or produced response of bad format. 
...
jest.mock('react-native', () => {
        ...
        NfcCardModule: {
            isRecoveryDataSet: jest.fn()
             ...
             .mockReturnValueOnce(new Promise((_resolve, reject) => {
              ...
              .mockReturnValueOnce(new Promise((_resolve, reject) => {
                reject(new Error("{\"message\":\"Command aborted, No precise diagnosis.\", \"code\": \"6F00\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction1\":\"IS_RECOVERY_DATA_SET\", \"apdu\":\"B0 D6 00 00 00  01\"}"
                ));
              }))
              .mockReturnValueOnce(new Promise((_resolve, reject) => {
                reject(new Error("{\"message\":\"Command aborted, No precise diagnosis.\", \"code\": \"6F00\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction\":\"\", \"apdu\":\"B0 D6 00 00 00  01\"}"
                ));
              }))
              .mockReturnValueOnce(new Promise((_resolve, reject) => {
                reject(new Error("{\"message\":\"Command aborted, No precise diagnosis.\", \"code\": \"6F00\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction\":\"IS_RECOVERY_DATA_SET\", \"apdu1\":\"B0 D6 00 00 00  01\"}"
                ));
              }))
              .mockReturnValueOnce(new Promise((_resolve, reject) => {
              ...
              .mockReturnValueOnce(new Promise((_resolve, reject) => {
                reject(new Error("{\"message\":\"Command aborted, No precise diagnosis.\", \"code\": \"6F00\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction\":\"IS_RECOVERY_DATA_SET\", \"apdu\":\"B0 D6 00 00 00  01\"}"
                ));
              }))
  ...
  */
  ...
  test('Test isRecoveryDataSet throws error if message field (in response) is empty', () => {
    return new NfcCardModuleWrapper().isRecoveryDataSet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test isRecoveryDataSet throws error if message field (in response) is absent', () => {
    return new NfcCardModuleWrapper().isRecoveryDataSet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
 ...
 test('Test isRecoveryDataSet throws error if message field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().isRecoveryDataSet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test isRecoveryDataSet throws error if message field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().isRecoveryDataSet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test isRecoveryDataSet throws error if status field (in response) is empty', () => {
    return new NfcCardModuleWrapper().isRecoveryDataSet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test isRecoveryDataSet throws error if status field (in response) is absent', () => {
    return new NfcCardModuleWrapper().isRecoveryDataSet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test isRecoveryDataSet throws error if status field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().isRecoveryDataSet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test isRecoveryDataSet throws error if status field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().isRecoveryDataSet()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test isRecoveryDataSet throws CardError if errorTypeId =  0', () => {
    ...
    .catch(error => {
        ...
        expect(error.apdu).toBe('B0 D6 00 00 00  01');
    });  
  });
