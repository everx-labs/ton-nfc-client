...
/**
 * Test addRecoveryData method behaviour if the function with the same title in NativeModule throwed a error or produced response of bad format. 
...
jest.mock('react-native', () => {
    return {
      NativeModules: {
        NfcCardModule: {
            addRecoveryData: jest.fn().mockReturnValueOnce(new Promise((_resolve, reject) => {
  ...
  */
  ...
  test('Test addRecoveryData throws error if message field (in response) is empty', () => {
    return new NfcCardModuleWrapper().addRecoveryData("0011003300110033001100330011003300110033001100330011003300110033")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test addRecoveryData throws error if message field (in response) is absent', () => {
    return new NfcCardModuleWrapper().addRecoveryData("0011003300110033001100330011003300110033001100330011003300110033")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
 ...
 test('Test addRecoveryData throws error if message field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().addRecoveryData("0011003300110033001100330011003300110033001100330011003300110033")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test addRecoveryData throws error if message field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().addRecoveryData("0011003300110033001100330011003300110033001100330011003300110033")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test addRecoveryData throws error if status field (in response) is empty', () => {
    return new NfcCardModuleWrapper().addRecoveryData("0011003300110033001100330011003300110033001100330011003300110033")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test addRecoveryData throws error if status field (in response) is absent', () => {
    return new NfcCardModuleWrapper().addRecoveryData("0011003300110033001100330011003300110033001100330011003300110033")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test addRecoveryData throws error if status field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().addRecoveryData("0011003300110033001100330011003300110033001100330011003300110033")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test addRecoveryData throws error if status field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().addRecoveryData("0011003300110033001100330011003300110033001100330011003300110033")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
