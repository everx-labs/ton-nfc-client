...
import {ERR_JSON_MUST_HAVE_MSG_FIELD, 
  ...
  ERR_JSON_TYPE_ID_FIELD_MUST_HAVE_VAL} from '../NfcCardModuleWrapper'
    /**
 * Test getCurrentSerialNumber method behaviour if the function with the same title in NativeModule throwed a error. 
...
jest.mock('react-native', () => {
    return {
      NativeModules: {
        NfcCardModule: {
            getCurrentSerialNumber: jest.fn().mockReturnValueOnce(new Promise((_resolve, reject) => {
  ...
  */
  ...
  test('Test getCurrentSerialNumber throws error if input arg is not json', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
  ...
  test('Test getCurrentSerialNumber throws error if message field (in response) is empty', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCurrentSerialNumber throws error if message field (in response) is absent', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
 ...
 test('Test getCurrentSerialNumber throws error if message field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCurrentSerialNumber throws error if message field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCurrentSerialNumber throws error if status field (in response) is empty', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCurrentSerialNumber throws error if status field (in response) is absent', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCurrentSerialNumber throws error if status field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCurrentSerialNumber throws error if status field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCurrentSerialNumber throws error if code field is empty', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCurrentSerialNumber throws error if code field is absent', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCurrentSerialNumber throws error if errorType field is empty', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCurrentSerialNumber throws error if errorType field is absent', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCurrentSerialNumber throws error if errorTypeId field is empty', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCurrentSerialNumber throws error if errorTypeId field is absent', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCurrentSerialNumber throws NfcNativeModuleError if errorTypeId >  0', () => {
    return new NfcCardModuleWrapper().getCurrentSerialNumber()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
