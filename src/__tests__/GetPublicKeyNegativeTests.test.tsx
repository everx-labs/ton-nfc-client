...
jest.mock('react-native', () => {
    return {
      NativeModules: {
        NfcCardModule: {
            getPublicKey: jest.fn().mockReturnValueOnce(new Promise((resolve, reject) => {
            ...
            getPublicKeyWithoutDialog: jest.fn().mockReturnValueOnce(new Promise((resolve, reject) => {
                reject(new Error("aaa"));
              }))
              .mockReturnValueOnce(new Promise((resolve, reject) => {
                reject(new Error("{\"message\":\"\", \"status\":\"fail\", \"code\": \"30006\", \"errorTypeId\": \"3\", \"errorType\": \"Native code fail: incorrect format of input data\"}"
  ...
  */
  ...
  test('Test getPublicKey throws error if input arg is not json', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
 ...
 test('Test getPublicKey throws error if message field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws error if message field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws error if status field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws error if status field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws error if code field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws error if code field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws error if errorType field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws error if errorType field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws error if errorTypeId field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws error if errorTypeId field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws error if cardInstruction field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws error if cardInstruction field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws error if apdu field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws error if apdu field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws CardError if errorTypeId =  0', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKey throws NfcNativeModuleError if errorTypeId >  0', () => {
    return new NfcCardModuleWrapper().getPublicKey("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  /*
  getPublicKeyWithoutDialog
  */

  test('Test getPublicKeyWithoutDialog: throws error if input arg is not json', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
    .catch(error => {
 ...
 test('Test getPublicKeyWithoutDialog throws error if message field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws error if message field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws error if status field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws error if status field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws error if code field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws error if code field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws error if errorType field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws error if errorType field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws error if errorTypeId field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws error if errorTypeId field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws error if cardInstruction field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws error if cardInstruction field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws error if apdu field is empty', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws error if apdu field is absent', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws CardError if errorTypeId =  0', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getPublicKeyWithoutDialog throws NfcNativeModuleError if errorTypeId >  0', () => {
    return new NfcCardModuleWrapper().getPublicKeyWithoutDialog("1")
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
