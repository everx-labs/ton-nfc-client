...
jest.mock('react-native', () => {
    return {
      NativeModules: {
        NfcCardModule: {
            getHashes: jest.fn().mockReturnValueOnce(new Promise((resolve, reject) => {
            ...
            getHashesWithoutDialog: jest.fn().mockReturnValueOnce(new Promise((resolve, reject) => {
                reject(new Error("aaa"));
              }))
              .mockReturnValueOnce(new Promise((resolve, reject) => {
                reject(new Error("{\"message\":\"\", \"status\":\"fail\", \"code\": \"30006\", \"errorTypeId\": \"3\", \"errorType\": \"Native code fail: incorrect format of input data\"}"
  ...
  */
  ...
  test('Test getHashesWithoutDialog: throws error if input arg is not json', () => {
