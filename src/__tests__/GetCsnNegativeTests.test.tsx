...
import {ERR_JSON_MUST_HAVE_MSG_FIELD, 
 ...
 /**
 * Test getCsn method behaviour if the function with the same title in NativeModule throwed a error. 
...
jest.mock('react-native', () => {
    return {
      NativeModules: {
        NfcCardModule: {
            getCsn: jest.fn().mockReturnValueOnce(new Promise((_resolve, reject) => {
  ...
  */
  ...
  test('Test getCsn throws error if message field (in response) is empty', () => {
    return new NfcCardModuleWrapper().getCsn()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCsn throws error if message field (in response) is absent', () => {
    return new NfcCardModuleWrapper().getCsn()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
 ...
 test('Test getCsn throws error if message field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().getCsn()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCsn throws error if message field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().getCsn()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCsn throws error if status field (in response) is empty', () => {
    return new NfcCardModuleWrapper().getCsn()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCsn throws error if status field (in response) is absent', () => {
    return new NfcCardModuleWrapper().getCsn()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCsn throws error if status field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().getCsn()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getCsn throws error if status field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().getCsn()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
