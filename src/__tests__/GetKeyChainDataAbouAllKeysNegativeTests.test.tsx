...
jest.mock('react-native', () => {
        ...
        NfcCardModule: {
            getKeyChainDataAboutAllKeys: jest.fn().mockReturnValueOnce(new Promise((resolve, reject) => {
             ...
             .mockReturnValueOnce(new Promise((resolve, reject) => {
              ...
              .mockReturnValueOnce(new Promise((resolve, reject) => {
                reject(new Error("{\"message\":\"Command aborted, No precise diagnosis.\", \"code\": \"6F00\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction1\":\"GET_NUMBER_OF_KEYS\", \"apdu\":\"B0 A2 00 00 44\"}"
                ));
              }))
              .mockReturnValueOnce(new Promise((resolve, reject) => {
              ...
              .mockReturnValueOnce(new Promise((resolve, reject) => {
                reject(new Error("{\"message\":\"Command aborted, No precise diagnosis.\", \"code\": \"6F00\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction\":\"GET_NUMBER_OF_KEYS\", \"apdu1\":\"B0 A2 00 00 44\"}"
                ));
              }))
              .mockReturnValueOnce(new Promise((resolve, reject) => {
              ...
              .mockReturnValueOnce(new Promise((resolve, reject) => {
                reject(new Error("{\"message\":\"Command aborted, No precise diagnosis.\", \"code\": \"6F00\", \"status\":\"fail\", \"errorTypeId\": \"0\", \"errorType\": \"Applet fail: card operation error\", \"cardInstruction\":\"GET_NUMBER_OF_KEYS\", \"apdu\":\"B0 A2 00 00 44\"}"
                ));
              }))
 ...
 test('Test getKeyChainDataAboutAllKeys throws error if message field is empty', () => {
  ...
  test('Test getKeyChainDataAboutAllKeys throws error if message field is absent', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeys throws error if status field is empty', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeys throws error if status field is absent', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeys()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
 ...
 test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if message field is empty', () => {
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if message field is absent', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if status field is empty', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if status field is absent', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if code field is empty', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if code field is absent', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if errorType field is empty', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if errorType field is absent', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if errorTypeId field is empty', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if errorTypeId field is absent', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if cardInstruction field is empty', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if cardInstruction field is absent', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if apdu field is empty', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws error if apdu field is absent', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws CardError if errorTypeId =  0', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getKeyChainDataAboutAllKeysWithoutDialog throws NfcNativeModuleError if errorTypeId >  0', () => {
    return new NfcCardModuleWrapper().getKeyChainDataAboutAllKeysWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
