...
jest.mock('react-native', () => {
    return {
      NativeModules: {
        NfcCardModule: {
            getAllSerialNumbers: jest.fn().mockReturnValueOnce(new Promise((_resolve, reject) => {
  ...
  */
  ...
  test('Test getAllSerialNumbers throws error if input arg is not json', () => {
 ...
 test('Test getAllSerialNumbers throws error if message field (in error msg) is empty', () => {
  ...
  test('Test getAllSerialNumbers throws error if code field is empty', () => {
    return new NfcCardModuleWrapper().getAllSerialNumbers()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getAllSerialNumbers throws error if code field is absent', () => {
    return new NfcCardModuleWrapper().getAllSerialNumbers()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getAllSerialNumbers throws error if errorType field is empty', () => {
    return new NfcCardModuleWrapper().getAllSerialNumbers()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getAllSerialNumbers throws error if errorType field is absent', () => {
    return new NfcCardModuleWrapper().getAllSerialNumbers()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getAllSerialNumbers throws error if errorTypeId field is empty', () => {
    return new NfcCardModuleWrapper().getAllSerialNumbers()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getAllSerialNumbers throws error if errorTypeId field is absent', () => {
    return new NfcCardModuleWrapper().getAllSerialNumbers()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test getAllSerialNumbers throws NfcNativeModuleError if errorTypeId >  0', () => {
    return new NfcCardModuleWrapper().getAllSerialNumbers()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
