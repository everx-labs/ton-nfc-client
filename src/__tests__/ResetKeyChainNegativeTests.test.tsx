...
jest.mock('react-native', () => {
    return {
      NativeModules: {
        NfcCardModule: {
            resetKeyChain: jest.fn().mockReturnValueOnce(new Promise((resolve, reject) => {
            ...
            resetKeyChainWithoutDialog: jest.fn().mockReturnValueOnce(new Promise((resolve, reject) => {
                reject(new Error("aaa"));
              }))
              .mockReturnValueOnce(new Promise((resolve, reject) => {
                reject(new Error("{\"message\":\"\", \"status\":\"fail\", \"code\": \"30006\", \"errorTypeId\": \"3\", \"errorType\": \"Native code fail: incorrect format of input data\"}"
 ...
 test('Test resetKeyChain throws error if message field is empty', () => {
    return new NfcCardModuleWrapper().resetKeyChain()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChain throws error if message field is absent', () => {
    return new NfcCardModuleWrapper().resetKeyChain()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChain throws error if status field is empty', () => {
    return new NfcCardModuleWrapper().resetKeyChain()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChain throws error if status field is absent', () => {
    return new NfcCardModuleWrapper().resetKeyChain()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  /*
  resetKeyChainWithoutDialog
  */

  test('Test resetKeyChainWithoutDialog: throws error if input arg is not json', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
    .catch(error => {
 ...
 test('Test resetKeyChainWithoutDialog throws error if message field is empty', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws error if message field is absent', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws error if status field is empty', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws error if status field is absent', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws error if code field is empty', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws error if code field is absent', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws error if errorType field is empty', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws error if errorType field is absent', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws error if errorTypeId field is empty', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws error if errorTypeId field is absent', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws error if cardInstruction field is empty', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws error if cardInstruction field is absent', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws error if apdu field is empty', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws error if apdu field is absent', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws CardError if errorTypeId =  0', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test resetKeyChainWithoutDialog throws NfcNativeModuleError if errorTypeId >  0', () => {
    return new NfcCardModuleWrapper().resetKeyChainWithoutDialog()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
