...
jest.mock('react-native', () => {
    return {
      NativeModules: {
        ...
        turnOnWalletWithPinWithoutDialog: jest.fn( (newPin: string,
            authenticationPassword: string,
            commonSecret: string,
            initialVector: string) => {
          return new Promise((resolve, reject) => {
        ...
        getHashOfEncryptedPasswordWithoutDialog: jest.fn( () => {
            return new Promise((resolve, reject) => {
              resolve("{\"message\":\"EFBF24AC1563B34ADB0FFE0B0A53659E72E26765704C109C95346EEAA1D4BEAF\", \"status\":\"ok\"}");
            })
        }),
  ...
  test('Positive test getHashesWithoutDialog', () => {
    let nfcCardModuleWrapper = new NfcCardModuleWrapper();
    return nfcCardModuleWrapper.getHashesWithoutDialog().then(cardRsponse => {
      console.log(cardRsponse.message);
      expect(cardRsponse.message).toBe("");
      expect(cardRsponse.status).toBe("ok");
      expect(cardRsponse.ecsHash).toBe("26D4B03C0C0E168DC33E48BBCEB457C21364658C9D487341827BBFFB4D8B38F3");
  ...
  test('Positive test getHashOfEncryptedPasswordWithoutDialog', () => {
    let nfcCardModuleWrapper = new NfcCardModuleWrapper();
    return nfcCardModuleWrapper.getHashOfEncryptedPasswordWithoutDialog().then(cardRsponse => {
      console.log(cardRsponse.message);
      expect(cardRsponse.message).toBe("EFBF24AC1563B34ADB0FFE0B0A53659E72E26765704C109C95346EEAA1D4BEAF");
      expect(cardRsponse.status).toBe("ok");
      expect(cardRsponse.ecsHash).toBe("");
  ...
  test('Positive test getHashOfEncryptedCommonSecretWithoutDialog', () => {
    let nfcCardModuleWrapper = new NfcCardModuleWrapper();
    return nfcCardModuleWrapper.getHashOfEncryptedCommonSecretWithoutDialog().then(cardRsponse => {
      console.log(cardRsponse.message);
      expect(cardRsponse.message).toBe("EFBF24AC1563B34ADB0FFE0B0A53659E72E26765704C109C95346EEAA1D4BEAF");
      expect(cardRsponse.status).toBe("ok");
      expect(cardRsponse.ecsHash).toBe("");
  ...
  */
  ...
  test('Positive test turnOnWalletWithPinWithoutDialog', () => {
    let nfcCardModuleWrapper = new NfcCardModuleWrapper();
    let pin = "5555";
    let p1 = "";
    let cs = "158BDE7FD53048BFF95E85947BBC08A1F4EF1A158F5975B0D7065CFB41F122C0";
    let sn = "504394802433901126813236";
    return nfcCardModuleWrapper.turnOnWalletWithPinWithoutDialog(pin, p1, cs, sn).then(cardRsponse => {
      console.log(cardRsponse.message);
      expect(cardRsponse.message).toBe("done");
      expect(cardRsponse.status).toBe("ok");
      expect(cardRsponse.ecsHash).toBe("");
  ...
  */
  ...
  test('Positive test turnOnWalletWithoutDialog', () => {
    let nfcCardModuleWrapper = new NfcCardModuleWrapper();
    let p1 = "";
    let cs = "158BDE7FD53048BFF95E85947BBC08A1F4EF1A158F5975B0D7065CFB41F122C0";
    let sn = "504394802433901126813236";
    return nfcCardModuleWrapper.turnOnWalletWithoutDialog(p1, cs, sn).then(cardRsponse => {
      console.log(cardRsponse.message);
      expect(cardRsponse.message).toBe("done");
      expect(cardRsponse.status).toBe("ok");
      expect(cardRsponse.ecsHash).toBe("");
