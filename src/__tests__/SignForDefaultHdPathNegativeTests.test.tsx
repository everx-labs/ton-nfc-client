...
/**
 * Test signForDefaultHdPath method behaviour if the function with the same title in NativeModule throwed a error or produced response of bad format. 
...
jest.mock('react-native', () => {
  ...
  */
  ...
  test('Test signForDefaultHdPath throws error if input arg is not json', () => {
  ...
  test('Test signForDefaultHdPath throws error if message field (in response) is empty', () => {
    return new NfcCardModuleWrapper().signForDefaultHdPath("123456AF")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test signForDefaultHdPath throws error if message field (in response) is absent', () => {
    return new NfcCardModuleWrapper().signForDefaultHdPath("123456AF")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
 ...
 test('Test signForDefaultHdPath throws error if message field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().signForDefaultHdPath("123456AF")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test signForDefaultHdPath throws error if message field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().signForDefaultHdPath("123456AF")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test signForDefaultHdPath throws error if status field (in response) is empty', () => {
    return new NfcCardModuleWrapper().signForDefaultHdPath("123456AF")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test signForDefaultHdPath throws error if status field (in response) is absent', () => {
    return new NfcCardModuleWrapper().signForDefaultHdPath("123456AF")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test signForDefaultHdPath throws error if status field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().signForDefaultHdPath("123456AF")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test signForDefaultHdPath throws error if status field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().signForDefaultHdPath("123456AF")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
