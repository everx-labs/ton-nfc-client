...
import {ERR_JSON_MUST_HAVE_MSG_FIELD, 
  ...
  ERR_JSON_MUST_HAVE_APDU_FIELD} from '../NfcCardModuleWrapper'
   ...
   /**
 * Test generateSeed method behaviour if the function with the same title in NativeModule throwed a error. 
...
jest.mock('react-native', () => {
    return {
      NativeModules: {
        NfcCardModule: {
            generateSeed: jest.fn().mockReturnValueOnce(new Promise((_resolve, reject) => {
  ...
  */
  ...
  test('Test generateSeed throws error if message field (in response) is empty', () => {
    return new NfcCardModuleWrapper().generateSeed("5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test generateSeed throws error if message field (in response) is absent', () => {
    return new NfcCardModuleWrapper().generateSeed("5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
 ...
 test('Test generateSeed throws error if message field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().generateSeed("5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test generateSeed throws error if message field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().generateSeed("5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test generateSeed throws error if status field (in response) is empty', () => {
    return new NfcCardModuleWrapper().generateSeed("5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test generateSeed throws error if status field (in response) is absent', () => {
    return new NfcCardModuleWrapper().generateSeed("5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test generateSeed throws error if status field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().generateSeed("5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test generateSeed throws error if status field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().generateSeed("5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
