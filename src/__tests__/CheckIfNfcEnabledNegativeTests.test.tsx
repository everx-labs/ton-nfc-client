...
jest.mock('react-native', () => {
 ...
 test('Test checkIfNfcEnabled throws error if message field is empty', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if message field is absent', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if status field is empty', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if status field is absent', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(cardRsponse => {
        expect(true).toBe(false);
    })
