...
/**
 * Test checkIfNfcEnabled method behaviour if the function with the same title in NativeModule throwed a error. 
...
jest.mock('react-native', () => {
    return {
      NativeModules: {
        NfcCardModule: {
            checkIfNfcEnabled: jest.fn().mockReturnValueOnce(new Promise((_resolve, reject) => {
  ...
  */
  ...
  test('Test checkIfNfcEnabled throws error if input arg is not json', () => {
  ...
  test('Test checkIfNfcEnabled throws error if message field (in response) is empty', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if message field (in response) is absent', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
 ...
 test('Test checkIfNfcEnabled throws error if message field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if message field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if status field (in response) is empty', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if status field (in response) is absent', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if status field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if status field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if code field is empty', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if code field is absent', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if errorType field is empty', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if errorType field is absent', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if errorTypeId field is empty', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws error if errorTypeId field is absent', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test checkIfNfcEnabled throws NfcNativeModuleError if errorTypeId >  0', () => {
    return new NfcCardModuleWrapper().checkIfNfcEnabled()
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
