...
/**
 * Test verifyPinAndSign method behaviour if the function with the same title in NativeModule throwed a error or produced response of bad format. 
...
jest.mock('react-native', () => {
  ...
  */
  ...
  test('Test verifyPinAndSign throws error if message field (in response) is empty', () => {
    return new NfcCardModuleWrapper().verifyPinAndSign("123456AF", "2", "5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test verifyPinAndSign throws error if message field (in response) is absent', () => {
    return new NfcCardModuleWrapper().verifyPinAndSign("123456AF", "2", "5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
 ...
 test('Test verifyPinAndSign throws error if message field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().verifyPinAndSign("123456AF", "2", "5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test verifyPinAndSign throws error if message field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().verifyPinAndSign("123456AF", "2", "5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test verifyPinAndSign throws error if status field (in response) is empty', () => {
    return new NfcCardModuleWrapper().verifyPinAndSign("123456AF", "2", "5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test verifyPinAndSign throws error if status field (in response) is absent', () => {
    return new NfcCardModuleWrapper().verifyPinAndSign("123456AF", "2", "5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test verifyPinAndSign throws error if status field (in error msg) is empty', () => {
    return new NfcCardModuleWrapper().verifyPinAndSign("123456AF", "2", "5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
  ...
  test('Test verifyPinAndSign throws error if status field (in error msg) is absent', () => {
    return new NfcCardModuleWrapper().verifyPinAndSign("123456AF", "2", "5555")
    .then(_cardRsponse => {
        expect(true).toBe(false);
    })
